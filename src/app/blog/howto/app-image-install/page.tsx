    ...
    return (
      ...
      <h2> How to install an App Image file</h2>
            <p>
                ...
                <TerminalBlock>./name.appImage --appimage-extract </TerminalBlock> Think of this as unzipping a .zip file, so you&apos;ll get all the content from the image which as it turns out, has EVERYTHING you need to run it from the menu; all you have to do is pointing it to the right path. 
                <p>{solution}</p>
                    <ol>
